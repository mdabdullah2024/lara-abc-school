        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Manage Marks Edit</a></li>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3>Student Marks Edit
                </h3>
              </div>
              <!-- /.card-header -->

              <div class="card-body">
                <form id="rollForm" method="POST" action="{{route('marks.entry.update')}}">
                  @csrf
                  <div class="form-row">
