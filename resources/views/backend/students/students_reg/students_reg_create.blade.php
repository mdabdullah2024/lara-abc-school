        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-light">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="student-data" action="{{ (@$editData)?route('students.registration.update',$editData->student_id):route('students.registration.store') }}" method="post" enctype="multipart/form-data">
                @csrf
