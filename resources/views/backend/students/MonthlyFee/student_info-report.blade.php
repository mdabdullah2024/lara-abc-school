	...
	<div class="container mt-0">
			...
			<div class="col-md-12">
				...
				<div class="col-md-12">
					<table border="1" width="100%">
						...
						$MontylyFee=App\Models\FeeAmount::where('fee_category_id','2')->where('class_id',$details->class_id)->first();
						$originalfee = $MontylyFee->amount;
						...
						<tr>
							<td style="width: 50%;">Montyly Fee</td>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-12 text-center">
					<h5 style="font-weight: bold; padding-top: -25px;">Student Montyly Fee</h5>
				</div>
				<div class="col-md-12">
					<table border="1" width="100%">
						@php
