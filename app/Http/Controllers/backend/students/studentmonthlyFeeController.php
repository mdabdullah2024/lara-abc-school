   ...
   public function index()
    {
        ...
        return view('backend.students.MonthlyFee.monthly_fee_view',$data);
    }
    public function getStudent2(Request $request)
    {
        ...
        $html['thsource'] .= '<th>Montyly Fee</th>';
    ...
    position: relative;" class=" btn btn-sm btn-'.$color.'" title="Payslip" target="_blank" href="'.route("students.monthly-fee.get-student-payslip").'?class_id='.$v->class_id.'&student_id='.$v->student_id.'&month='.$request->month.'" >Fee Slip</a>';
            $html[$key]['tdsource'] .= '</td>';
    ...
    public function payslip(Request $request)
    {
        ...
        $pdf= PDF::loadView('backend.students.MonthlyFee.student_info-report',$data);
