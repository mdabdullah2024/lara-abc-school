...
class MarksEntryController extends Controller
{
    public function index()
    {
        ...
        $data['allData'] = StudentMarks::all();
        return view('backend.StudentMarksManagements.MarksEntry.marks_entry_add',$data);
    }
    public function store(Request $request){
        ...
        return redirect()->route('marks.entry.index')->with('success','Well Done !  Marks Entry Successful.' );
    }
    public function edit()
    {
        ...
        return view('backend.StudentMarksManagements.MarksEntry.marks_entry_edit',$data);
